...
namespace Proyecto26
{
    public static class HttpBase
    {
        ...
        {
            return new RequestException(request.error, request.result == UnityWebRequest.Result.ProtocolError, 
                request.result == UnityWebRequest.Result.ConnectionError, request.responseCode, request.downloadHandler.text);
        }
